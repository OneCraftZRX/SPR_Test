...
def getPositionData(gps):
    ...
    if nx['class'] == 'TPV':
        latitude = getattr(nx,'lat', "Initializing")
        longitude = getattr(nx,'lon', "Initializing")
...
class Video_task(threading.Thread):
    def __init__(self, camera_id, img_height, img_width):
        ...
        cv2.putText(self.frame, 'NO VIDEO', (10, 140), cv2.FONT_HERSHEY_SIMPLEX, 2, 50, 5)
    ...
    def gps_feed(self):
        while True:
            ...
            # AddText = src.copy()
            cv2.putText(src, text, (0, 20), cv2.FONT_HERSHEY_COMPLEX, 0.6, (0, 0, 0), 1)
